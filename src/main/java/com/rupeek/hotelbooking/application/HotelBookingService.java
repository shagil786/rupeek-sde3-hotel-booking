...
public class HotelBookingService {
    ...
    public HotelDtos.BookingResponse pay(String bookingId, HotelDtos.PaymentRequest request, String actor, String idempotencyKey) {
        ...
        payments.save(new PaymentEntity(UUID.randomUUID().toString(),booking,request.method(),booking.getAmount(),result.successful()?PaymentStatus.SUCCEEDED:PaymentStatus.FAILED));
    ...
    public void cancel(String bookingId, String actor, String idempotencyKey) {
        ...
        booking.setStatus(BookingStatus.CANCELLED); bookings.save(booking);
    }
